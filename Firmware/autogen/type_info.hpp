...
struct ODriveControllerTypeInfo : TypeInfo {
    ...
    introspectable_storage_t get_child(introspectable_storage_t obj, size_t idx) const override {
        ...
        switch (idx) {
            ...
            case 3: *(decltype(ODriveIntf::ControllerIntf::get_input_current(std::declval<T*>()))*)(&res) = ODriveIntf::ControllerIntf::get_input_current(ptr); break;
            ...
            case 6: *(decltype(ODriveIntf::ControllerIntf::get_current_setpoint(std::declval<T*>()))*)(&res) = ODriveIntf::ControllerIntf::get_current_setpoint(ptr); break;
            ...
            case 8: *(decltype(ODriveIntf::ControllerIntf::get_vel_integrator_current(std::declval<T*>()))*)(&res) = ODriveIntf::ControllerIntf::get_vel_integrator_current(ptr); break;
...
struct ODriveMotorConfigTypeInfo : TypeInfo {
    ...
    introspectable_storage_t get_child(introspectable_storage_t obj, size_t idx) const override {
        ...
        switch (idx) {
            ...
            case 6: *(decltype(ODriveIntf::MotorIntf::ConfigIntf::get_direction(std::declval<T*>()))*)(&res) = ODriveIntf::MotorIntf::ConfigIntf::get_direction(ptr); break;
            ...
            case 10: *(decltype(ODriveIntf::MotorIntf::ConfigIntf::get_inverter_temp_limit_lower(std::declval<T*>()))*)(&res) = ODriveIntf::MotorIntf::ConfigIntf::get_inverter_temp_limit_lower(ptr); break;
            case 11: *(decltype(ODriveIntf::MotorIntf::ConfigIntf::get_inverter_temp_limit_upper(std::declval<T*>()))*)(&res) = ODriveIntf::MotorIntf::ConfigIntf::get_inverter_temp_limit_upper(ptr); break;
            case 12: *(decltype(ODriveIntf::MotorIntf::ConfigIntf::get_requested_current_range(std::declval<T*>()))*)(&res) = ODriveIntf::MotorIntf::ConfigIntf::get_requested_current_range(ptr); break;
            case 13: *(decltype(ODriveIntf::MotorIntf::ConfigIntf::get_current_control_bandwidth(std::declval<T*>()))*)(&res) = ODriveIntf::MotorIntf::ConfigIntf::get_current_control_bandwidth(ptr); break;
            case 14: *(decltype(ODriveIntf::MotorIntf::ConfigIntf::get_acim_slip_velocity(std::declval<T*>()))*)(&res) = ODriveIntf::MotorIntf::ConfigIntf::get_acim_slip_velocity(ptr); break;
...
struct ODriveControllerConfigTypeInfo : TypeInfo {
    ...
    introspectable_storage_t get_child(introspectable_storage_t obj, size_t idx) const override {
        ...
        switch (idx) {
            ...
            case 13: *(decltype(ODriveIntf::ControllerIntf::ConfigIntf::get_current_ramp_rate(std::declval<T*>()))*)(&res) = ODriveIntf::ControllerIntf::ConfigIntf::get_current_ramp_rate(ptr); break;
...
const PropertyInfo ODriveControllerTypeInfo<T>::property_table[] = {
    ...
    {"input_current", &FibrePropertyTypeInfo<std::remove_reference_t<decltype(*ODriveIntf::ControllerIntf::get_input_current(std::declval<T*>()))>>::singleton},
    ...
    {"current_setpoint", &FibrePropertyTypeInfo<std::remove_reference_t<decltype(*ODriveIntf::ControllerIntf::get_current_setpoint(std::declval<T*>()))>>::singleton},
    ...
    {"vel_integrator_current", &FibrePropertyTypeInfo<std::remove_reference_t<decltype(*ODriveIntf::ControllerIntf::get_vel_integrator_current(std::declval<T*>()))>>::singleton},
...
const PropertyInfo ODriveControllerConfigTypeInfo<T>::property_table[] = {
    ...
    {"current_ramp_rate", &FibrePropertyTypeInfo<std::remove_reference_t<decltype(*ODriveIntf::ControllerIntf::ConfigIntf::get_current_ramp_rate(std::declval<T*>()))>>::singleton},
