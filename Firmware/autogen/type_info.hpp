...
struct ODriveAxisConfigTypeInfo : TypeInfo {
    ...
    introspectable_storage_t get_child(introspectable_storage_t obj, size_t idx) const override {
        ...
        switch (idx) {
            ...
            case 8: *(decltype(ODriveIntf::AxisIntf::ConfigIntf::get_counts_per_step(std::declval<T*>()))*)(&res) = ODriveIntf::AxisIntf::ConfigIntf::get_counts_per_step(ptr); break;
            case 9: *(decltype(ODriveIntf::AxisIntf::ConfigIntf::get_watchdog_timeout(std::declval<T*>()))*)(&res) = ODriveIntf::AxisIntf::ConfigIntf::get_watchdog_timeout(ptr); break;
            case 10: *(decltype(ODriveIntf::AxisIntf::ConfigIntf::get_enable_watchdog(std::declval<T*>()))*)(&res) = ODriveIntf::AxisIntf::ConfigIntf::get_enable_watchdog(ptr); break;
            case 11: *(decltype(ODriveIntf::AxisIntf::ConfigIntf::get_step_gpio_pin(std::declval<T*>()))*)(&res) = ODriveIntf::AxisIntf::ConfigIntf::get_step_gpio_pin(ptr); break;
            case 12: *(decltype(ODriveIntf::AxisIntf::ConfigIntf::get_dir_gpio_pin(std::declval<T*>()))*)(&res) = ODriveIntf::AxisIntf::ConfigIntf::get_dir_gpio_pin(ptr); break;
            case 13: *(decltype(ODriveIntf::AxisIntf::ConfigIntf::get_calibration_lockin(std::declval<T*>()))*)(&res) = ODriveIntf::AxisIntf::ConfigIntf::get_calibration_lockin(ptr); break;
            case 14: *(decltype(ODriveIntf::AxisIntf::ConfigIntf::get_sensorless_ramp(std::declval<T*>()))*)(&res) = ODriveIntf::AxisIntf::ConfigIntf::get_sensorless_ramp(ptr); break;
            case 15: *(decltype(ODriveIntf::AxisIntf::ConfigIntf::get_general_lockin(std::declval<T*>()))*)(&res) = ODriveIntf::AxisIntf::ConfigIntf::get_general_lockin(ptr); break;
            case 16: *(decltype(ODriveIntf::AxisIntf::ConfigIntf::get_can_node_id(std::declval<T*>()))*)(&res) = ODriveIntf::AxisIntf::ConfigIntf::get_can_node_id(ptr); break;
            case 17: *(decltype(ODriveIntf::AxisIntf::ConfigIntf::get_can_node_id_extended(std::declval<T*>()))*)(&res) = ODriveIntf::AxisIntf::ConfigIntf::get_can_node_id_extended(ptr); break;
            case 18: *(decltype(ODriveIntf::AxisIntf::ConfigIntf::get_can_heartbeat_rate_ms(std::declval<T*>()))*)(&res) = ODriveIntf::AxisIntf::ConfigIntf::get_can_heartbeat_rate_ms(ptr); break;
        }
        return res;
    }
};
