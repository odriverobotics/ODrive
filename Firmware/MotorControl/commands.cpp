...
const Endpoint endpoints[] = {
    ...
    Endpoint::make_property("fw_version_major", &fw_version_major),
    Endpoint::make_property("fw_version_minor", &fw_version_minor),
    Endpoint::make_property("fw_version_revision", &fw_version_revision),
    Endpoint::make_property("fw_version_unreleased", &fw_version_unreleased),
