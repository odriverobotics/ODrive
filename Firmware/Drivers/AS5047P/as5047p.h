...
//!
typedef struct _AS5047P_Obj_ *AS5047P_Handle;
...
extern uint16_t AS5047P_readPosition(AS5047P_Handle handle);
extern uint16_t AS5047P_readSpi(AS5047P_Handle handle, uint16_t command);
extern uint16_t AS5047P_readAngle(AS5047P_Handle handle);
extern bool AS5047P_setZeroPos(AS5047P_Handle handle);
