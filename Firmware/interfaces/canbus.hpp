...
public:
    ...
    /**
     * @brief Checks if the specified baud rate is compatible with this
     * interface.
     * 
     * This function can be used regardless of started/stopped state of the CAN
     * bus.
     */
    virtual bool is_valid_baud_rate(uint32_t baud_rate) = 0;
     ...
     */
    virtual bool start(uint32_t baud_rate, on_event_cb_t rx_event_loop, on_error_cb_t on_error) = 0;
